...
def main() -> None:
    ...
    # Note: damp_mode="hold" — Quest 3 has no thumb-away gesture, velocity
    # either comes from stick or is zero, so "hold" vs "decay" is irrelevant.
        ...
        try:
            while viewer.is_running():
                ...
                if k % CTRL_DECIM == 0:
                    ...
                    # Quest 3 never enters DAMP — always pass False
                    thumb_away  = False
